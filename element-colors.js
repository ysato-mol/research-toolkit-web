(function (root, factory) {
  ...
  if (root) root.StructureViewerElementColors = api;
})(typeof window !== "undefined" ? window : globalThis, function () {
  "use strict";

  // Keep this palette identical to preferences.js defaultAtomColors.
  const DEFAULT_ATOM_COLORS = Object.freeze({
    ...
    Sg: "#d90045", Bh: "#e00038", Hs: "#e6002e", Mt: "#eb0026", Ds: "#f0001c",
    Rg: "#f50014", Cn: "#fa000a", Nh: "#d0d0d0", Fl: "#c8c8c8", Mc: "#c0c0c0",
    Lv: "#b8b8b8", Ts: "#b0b0b0", Og: "#a8a8a8", metal: "#8aa0b8", X: "#64748b",
  });

  return { DEFAULT_ATOM_COLORS };
});
